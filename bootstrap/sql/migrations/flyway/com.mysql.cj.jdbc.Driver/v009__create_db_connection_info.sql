...
SET json = JSON_REMOVE(json, '$.metaMartServerConnection');
...
WHERE name = 'MetaMart' AND JSON_EXTRACT(json, '$.connection.config.authProvider') != 'google';
...
WHERE serviceType in ('Amundsen', 'Atlas', 'MetadataES', 'MetaMart');
