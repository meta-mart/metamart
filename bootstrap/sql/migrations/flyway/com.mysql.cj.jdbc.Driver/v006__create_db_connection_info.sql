...
-- We removed the supportsMetadataExtraction field in the `MetaMartConnection` object being used in IngestionPipelines
UPDATE ingestion_pipeline_entity
SET json = JSON_REMOVE(json ,'$.metaMartServerConnection.supportsMetadataExtraction');
