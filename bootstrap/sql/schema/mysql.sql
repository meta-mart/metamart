...
CREATE TABLE `automations_workflow` (
  ...
  `workflowType` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  `status` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  `json` json NOT NULL,
  ...
  `nameHash` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `nameHash` (`nameHash`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DIGITRANS=utf8mb4_0900_ai_ci;
...
CREATE TABLE `chart_entity` (
  ...
  `updatedBy` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.updatedBy'))) VIRTUAL NOT NULL,
  `deleted` tinyint(1) GENERATED ALWAYS AS (json_extract(`json`,_utf8mb4'$.deleted')) VIRTUAL,
  `fqnHash` varchar(768) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  `name` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.name'))) VIRTUAL NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `data_product_entity` (
  `id` varchar(36) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.id'))) STORED NOT NULL,
  `name` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.name'))) VIRTUAL NOT NULL,
  `fqnHash` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin NOT NULL,
  `json` json NOT NULL,
  `updatedAt` bigint unsigned GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.updatedAt'))) VIRTUAL NOT NULL,
  `updatedBy` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.updatedBy'))) VIRTUAL NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `entity_extension` (
  ...
  `extension` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin NOT NULL,
...
CREATE TABLE `entity_extension_time_series` (
  `extension` varchar(100) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  `jsonSchema` varchar(50) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  `json` json NOT NULL,
  `timestamp` bigint unsigned GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.timestamp'))) VIRTUAL NOT NULL,
  `entityFQNHash` varchar(768) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
...
CREATE TABLE `field_relationship` (
  ...
  `jsonSchema` varchar(256) DEFAULT NULL,
  `json` json DEFAULT NULL,
  `fromFQNHash` varchar(768) CHARACTER SET ascii DIGITRANS ascii_bin NOT NULL,
  `toFQNHash` varchar(768) CHARACTER SET ascii DIGITRANS ascii_bin NOT NULL,
...
CREATE TABLE `glossary_term_entity` (
  ...
  `updatedBy` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.updatedBy'))) VIRTUAL NOT NULL,
  `deleted` tinyint(1) GENERATED ALWAYS AS (json_extract(`json`,_utf8mb4'$.deleted')) VIRTUAL,
  `fqnHash` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  `name` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.name'))) VIRTUAL NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `fqnHash` (`fqnHash`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 DIGITRANS=utf8mb4_0900_ai_ci;
...
--
-- Table structure for table `metamart_settings`
--

DROP TABLE IF EXISTS `metamart_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `metamart_settings` (
...
CREATE TABLE `search_service_entity` (
  `id` varchar(36) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.id'))) STORED NOT NULL,
  `nameHash` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin NOT NULL,
  `name` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.name'))) VIRTUAL NOT NULL,
  `serviceType` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.serviceType'))) VIRTUAL NOT NULL,
  `json` json NOT NULL,
  `updatedAt` bigint unsigned GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.updatedAt'))) VIRTUAL NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 DIGITRANS=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tag_usage` (
  ...
  `tagFQNHash` varchar(768) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
  `targetFQNHash` varchar(768) CHARACTER SET ascii DIGITRANS ascii_bin DEFAULT NULL,
...
CREATE TABLE `task_sequence` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 DIGITRANS=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `thread_entity` (
  ...
  `createdBy` varchar(256) CHARACTER SET ascii DIGITRANS ascii_bin GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.createdBy'))) STORED NOT NULL,
  `updatedAt` bigint unsigned GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.updatedAt'))) VIRTUAL NOT NULL,
  `updatedBy` varchar(256) GENERATED ALWAYS AS (json_unquote(json_extract(`json`,_utf8mb4'$.updatedBy'))) VIRTUAL NOT NULL,
