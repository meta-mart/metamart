...
```
  - category: Main Concepts / Metadata Standard / Schemas / Metamart-docs / Content / Main-concepts / Metadata-standard / Schemas
...
SOURCES_ROOT = "metamart-spec/src/main/resources/json/schema"
SINK_ROOT = "metamart-docs/content/v1.2.x"
