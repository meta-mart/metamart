...
os.environ["AIRFLOW__METAMART_AIRFLOW_APIS__DAG_GENERATED_CONFIGS"] = "/tmp/airflow"
os.environ["AIRFLOW__METAMART_AIRFLOW_APIS__DAG_RUNNER_TEMPLATE"] = str(
    (
...
from metamart_managed_apis.operations.state import disable_dag, enable_dag
...
class TestAirflowOps(TestCase):
    ...
    def test_dag_deploy_and_delete(self):
        ...
        ingestion_pipeline = IngestionPipeline(
            ...
            metaMartServerConnection=self.conn,
