...
import static org.metamart.service.Entity.ADMIN_ROLE;
...
public final class UserUtil {
   ...
   *   <li>Otherwise:
   *       <ul>
   *         <li>If airflow configuration is 'metamart' and server auth provider is not basic, add JWT auth
  ...
  private static JWTAuthMechanism buildJWTAuthMechanism(
      MetaMartJWTClientConfig jwtClientConfig, User user) {
