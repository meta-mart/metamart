...
package org.metamart.service.util.email;

import static org.metamart.service.util.email.TemplateConstants.ACCOUNT_ACTIVITY_CHANGE_TEMPLATE;
import static org.metamart.service.util.email.TemplateConstants.ACCOUNT_STATUS_SUBJECT;
import static org.metamart.service.util.email.TemplateConstants.ACTION_KEY;
import static org.metamart.service.util.email.TemplateConstants.ACTION_STATUS_KEY;
import static org.metamart.service.util.email.TemplateConstants.APPLICATION_LOGIN_LINK;
import static org.metamart.service.util.email.TemplateConstants.CHANGE_EVENT_TEMPLATE;
import static org.metamart.service.util.email.TemplateConstants.CHANGE_EVENT_UPDATE;
import static org.metamart.service.util.email.TemplateConstants.DEFAULT_EXPIRATION_TIME;
import static org.metamart.service.util.email.TemplateConstants.EMAIL_IGNORE_MSG;
import static org.metamart.service.util.email.TemplateConstants.EMAIL_VERIFICATION_LINKKEY;
import static org.metamart.service.util.email.TemplateConstants.EMAIL_VERIFICATION_SUBJECT;
import static org.metamart.service.util.email.TemplateConstants.EMAIL_VERIFICATION_TEMPLATE;
import static org.metamart.service.util.email.TemplateConstants.ENTITY;
import static org.metamart.service.util.email.TemplateConstants.EXPIRATION_TIME_KEY;
import static org.metamart.service.util.email.TemplateConstants.INVITE_RANDOM_PASSWORD_TEMPLATE;
import static org.metamart.service.util.email.TemplateConstants.INVITE_SUBJECT;
import static org.metamart.service.util.email.TemplateConstants.PASSWORD;
import static org.metamart.service.util.email.TemplateConstants.PASSWORD_RESET_SUBJECT;
import static org.metamart.service.util.email.TemplateConstants.REPORT_SUBJECT;
import static org.metamart.service.util.email.TemplateConstants.SUPPORT_URL;
import static org.metamart.service.util.email.TemplateConstants.TASK_SUBJECT;
import static org.metamart.service.util.email.TemplateConstants.TEST_EMAIL_SUBJECT;
import static org.metamart.service.util.email.TemplateConstants.TEST_MAIL_TEMPLATE;
...
import org.metamart.service.events.scheduled.template.DataInsightDescriptionAndOwnerTemplate;
import org.metamart.service.events.scheduled.template.DataInsightTotalAssetTemplate;
    ...
    if (Boolean.TRUE.equals(getSmtpSettings().getEnableSmtpServer())) {
      ...
      Map<String, Object> templatePopulator =
          new TemplatePopulatorBuilder()
              ...
              .add(APPLICATION_LOGIN_LINK, getSmtpSettings().getMetaMartUrl())
              .build();
      ...
      Map<String, Object> templatePopulator =
          new TemplatePopulatorBuilder()
              ...
              .add(
                  "viewReportUrl",
                  String.format(
                      "%s/data-insights/data-assets", getSmtpSettings().getMetaMartUrl()))
              .build();
