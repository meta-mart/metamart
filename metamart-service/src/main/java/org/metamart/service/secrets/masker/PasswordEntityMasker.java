...
import org.metamart.service.exception.EntityMaskException;
import org.metamart.service.fernet.Fernet;
import org.metamart.service.secrets.SecretsUtil;
      ...
      Arrays.stream(toMaskObject.getClass().getMethods())
          ...
          .forEach(
              method -> {
                ...
                if (obj != null && obj.getClass().getPackageName().startsWith("org.metamart")) {
                  // maskPasswordFields
