...
import static org.metamart.service.Entity.APPLICATION;
import static org.metamart.service.Entity.BOT;
import static org.metamart.service.Entity.FIELD_OWNERS;
import static org.metamart.service.jdbi3.EntityRepository.getEntitiesFromSeedData;
...
@Tag(
    name = "Apps",
    description = "Apps are internal/external apps used to something on top of Meta-mart.")
...
public class AppResource extends EntityResource<App, AppRepository> {
  ...
  private void unsetAppRuntimeProperties(App app) {
    app.setMetaMartServerConnection(null);
  ...
  private void decryptOrNullify(
    ...
    MetaMartConnection metaMartServerConnection =
        new MetaMartConnectionBuilder(metaMartApplicationConfig, botName).build();
    ingestionPipeline.setMetaMartServerConnection(
        secretsManager.encryptMetaMartConnection(metaMartServerConnection, false));
  ...
  private IngestionPipeline getIngestionPipeline(
    ...
    ingestionPipeline.setMetaMartServerConnection(app.getMetaMartServerConnection());
