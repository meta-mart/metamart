...
import static org.metamart.schema.entity.teams.AuthenticationMechanism.AuthType.JWT;
...
import static org.metamart.service.jdbi3.UserRepository.AUTH_MECHANISM_FIELD;
import static org.metamart.service.secrets.ExternalSecretsManager.NULL_SECRET_STRING;
import static org.metamart.service.security.jwt.JWTTokenGenerator.getExpiryDate;
import static org.metamart.service.util.UserUtil.getRoleListFromUser;
import static org.metamart.service.util.UserUtil.getRolesFromAuthorizationToken;
import static org.metamart.service.util.UserUtil.getUser;
import static org.metamart.service.util.UserUtil.reSyncUserRolesFromToken;
import static org.metamart.service.util.UserUtil.validateAndGetRolesRef;
...
import org.metamart.service.security.CatalogPrincipal;
...
import org.metamart.service.util.email.TemplateConstants;
...
public class UserResource extends EntityResource<User, UserRepository> {
  ...
  private Response createOrUpdateBot(
    ...
    // TODO: review this flow on https://github.com/meta-mart/MetaMart/issues/8321
    if (original != null) {
