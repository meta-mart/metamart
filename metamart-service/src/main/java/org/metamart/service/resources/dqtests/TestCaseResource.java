...
import org.metamart.schema.api.tests.CreateLogicalTestCases;
...
import org.metamart.service.jdbi3.Filter;
...
public class TestCaseResource extends EntityResource<TestCase, TestCaseRepository> {
  ...
  public ResultList<TestCase> listFromSearch(
      ...
      @Parameter(
          ...
          String type,
      @Parameter(
              description = "Filter for test case by source (e.g. MetaMart, dbt, etc.)",
              schema = @Schema(type = "string"))
