...
package org.metamart.service.resources.types;
...
import org.metamart.service.jdbi3.TypeRepository;
...
@Tag(
    name = "Metadata",
    description =
        "These APIs are for adding new `Types` to MetaMart and use those `Types` to "
...
public class TypeResource extends EntityResource<Type, TypeRepository> {
  ...
  public void initialize(MetaMartApplicationConfig config) {
    // Load types defined in MetaMart schemas
