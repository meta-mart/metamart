...
import org.metamart.schema.api.data.LoadGlossary;
...
import org.metamart.service.jdbi3.GlossaryRepository;
import org.metamart.service.jdbi3.GlossaryTermRepository;
...
public class GlossaryTermResource extends EntityResource<GlossaryTerm, GlossaryTermRepository> {
  ...
  public void initialize(MetaMartApplicationConfig config) throws IOException {
    ...
    // Load glossaries provided by MetaMart
