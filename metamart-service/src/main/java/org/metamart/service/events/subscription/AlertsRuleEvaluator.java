...
import static org.metamart.schema.type.Function.ParameterType.ALL_INDEX_ELASTIC_SEARCH;
import static org.metamart.schema.type.Function.ParameterType.READ_FROM_PARAM_CONTEXT;
import static org.metamart.schema.type.Function.ParameterType.READ_FROM_PARAM_CONTEXT_PER_ENTITY;
import static org.metamart.schema.type.Function.ParameterType.SPECIFIC_INDEX_ELASTIC_SEARCH;
import static org.metamart.schema.type.ThreadType.Conversation;
import static org.metamart.service.Entity.INGESTION_PIPELINE;
...
import org.metamart.schema.type.StatusType;
...
public class AlertsRuleEvaluator {
  ...
  public boolean matchPipelineState(List<String> pipelineState) {
    ...
    for (FieldChange fieldChange : changeEvent.getChangeDescription().getFieldsUpdated()) {
      if (fieldChange.getName().equals("pipelineStatus") && fieldChange.getNewValue() != null) {
        org.metamart.schema.entity.data.PipelineStatus pipelineStatus =
            JsonUtils.convertValue(
                fieldChange.getNewValue(),
                org.metamart.schema.entity.data.PipelineStatus.class);
