package org.metamart.service.migration.utils.v150;
...
import org.metamart.service.jdbi3.AppMarketPlaceRepository;
...
public class MigrationUtil {
  ...
  public static void deleteLegacyDataInsightPipelines(
    ...
    String dataInsightsPipelineNameFqn = "MetaMart.MetaMart_dataInsight";
  ...
  public static void migrateTestCaseDimension(Handle handle, CollectionDAO collectionDAO) {
    String MYSQL_TEST_CASE_DIMENSION_QUERY =
        "SELECT json FROM test_definition WHERE JSON_CONTAINS(json -> '$.testPlatforms', '\"MetaMart\"')";
    String POSTGRES_TEST_CASE_DIMENSION_QUERY =
        "SELECT json FROM test_definition WHERE json -> 'testPlatforms' @> '\"MetaMart\"'";
