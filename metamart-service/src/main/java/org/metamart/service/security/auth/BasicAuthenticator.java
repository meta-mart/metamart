...
import static org.metamart.schema.api.teams.CreateUser.CreatePasswordType.ADMIN_CREATE;
import static org.metamart.schema.auth.ChangePasswordRequest.RequestType.SELF;
import static org.metamart.schema.auth.ChangePasswordRequest.RequestType.USER;
import static org.metamart.schema.auth.TokenType.EMAIL_VERIFICATION;
import static org.metamart.schema.auth.TokenType.PASSWORD_RESET;
import static org.metamart.schema.entity.teams.AuthenticationMechanism.AuthType.BASIC;
import static org.metamart.service.exception.CatalogExceptionMessage.EMAIL_EXISTS;
import static org.metamart.service.exception.CatalogExceptionMessage.EMAIL_SENDING_ISSUE;
import static org.metamart.service.exception.CatalogExceptionMessage.FAILED_SEND_EMAIL;
import static org.metamart.service.exception.CatalogExceptionMessage.INCORRECT_OLD_PASSWORD;
import static org.metamart.service.exception.CatalogExceptionMessage.INVALID_TOKEN;
import static org.metamart.service.exception.CatalogExceptionMessage.INVALID_USERNAME_PASSWORD;
import static org.metamart.service.exception.CatalogExceptionMessage.INVALID_USER_OR_PASSWORD;
import static org.metamart.service.exception.CatalogExceptionMessage.MAX_FAILED_LOGIN_ATTEMPT;
import static org.metamart.service.exception.CatalogExceptionMessage.PASSWORD_RESET_TOKEN_EXPIRED;
import static org.metamart.service.exception.CatalogExceptionMessage.SELF_SIGNUP_DISABLED_MESSAGE;
import static org.metamart.service.exception.CatalogExceptionMessage.SELF_SIGNUP_NOT_ENABLED;
import static org.metamart.service.exception.CatalogExceptionMessage.TOKEN_EXPIRED;
import static org.metamart.service.exception.CatalogExceptionMessage.TOKEN_EXPIRY_ERROR;
import static org.metamart.service.resources.teams.UserResource.USER_PROTECTED_FIELDS;
...
import static org.metamart.service.util.email.EmailUtil.sendAccountStatus;
import static org.metamart.service.util.email.TemplateConstants.APPLICATION_LOGIN_LINK;
import static org.metamart.service.util.email.TemplateConstants.ENTITY;
import static org.metamart.service.util.email.TemplateConstants.INVITE_CREATE_PASSWORD_TEMPLATE;
import static org.metamart.service.util.email.TemplateConstants.INVITE_RANDOM_PASSWORD_TEMPLATE;
import static org.metamart.service.util.email.TemplateConstants.PASSWORD;
import static org.metamart.service.util.email.TemplateConstants.SUPPORT_URL;
import static org.metamart.service.util.email.TemplateConstants.USERNAME;
...
import org.metamart.schema.auth.EmailVerificationToken;
...
import org.metamart.schema.auth.PasswordResetToken;
...
import org.metamart.service.security.AuthenticationException;
...
import org.metamart.service.util.PasswordUtil;
  ...
  public void sendInviteMailToUser(
    ...
    switch (requestType) {
      case ADMIN_CREATE -> {
        ...
        templatePopulator.put(APPLICATION_LOGIN_LINK, getSmtpSettings().getMetaMartUrl());
        try {
          EmailUtil.sendMail(
