...
import org.metamart.catalog.type.SamlSecurityConfig;
...
public class SamlSettingsHolder {
  ...
  public void initDefaultSettings(MetaMartApplicationConfig catalogApplicationConfig)
    ...
    samlData.put(SettingsBuilder.UNIQUE_ID_PREFIX_PROPERTY_KEY, "METAMART_");
