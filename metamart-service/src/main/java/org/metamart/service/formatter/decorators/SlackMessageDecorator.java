...
import org.metamart.service.apps.bundles.changeEvent.slack.SlackAttachment;
...
public class SlackMessageDecorator implements MessageDecorator<SlackMessage> {
  ...
  private SlackMessage getSlackTestMessage(String publisherName) {
    if (!publisherName.isEmpty()) {
      ...
      attachment.setText(
          "This is a test message from MetaMart confirming that your Slack destination is correctly set up to receive alerts.");
      attachment.setFooter("MetaMart");
