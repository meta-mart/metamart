...
import org.metamart.service.resources.services.ingestionpipelines.IngestionPipelineResource;
...
public class IngestionPipelineRepository extends EntityRepository<IngestionPipeline> {
  ...
  @Getter private final MetaMartApplicationConfig metaMartApplicationConfig;

  public IngestionPipelineRepository(MetaMartApplicationConfig config) {
    super(
  ...
  public void storeEntity(IngestionPipeline ingestionPipeline, boolean update) {
    ...
    MetaMartConnection metamartConnection =
        ingestionPipeline.getMetaMartServerConnection();
    ...
    if (secretsManager != null) {
      ...
      metamartConnection =
          secretsManager.encryptMetaMartConnection(metamartConnection, true);
    }

    ingestionPipeline.withService(null).withMetaMartServerConnection(null);
    store(ingestionPipeline, update);
    ingestionPipeline.withService(service).withMetaMartServerConnection(metamartConnection);
  }
