...
import static org.metamart.schema.type.EventType.POST_UPDATED;
import static org.metamart.schema.type.EventType.TASK_CLOSED;
import static org.metamart.schema.type.EventType.TASK_RESOLVED;
import static org.metamart.schema.type.EventType.THREAD_UPDATED;
import static org.metamart.schema.type.Include.ALL;
import static org.metamart.schema.type.Include.NON_DELETED;
import static org.metamart.schema.type.Relationship.ADDRESSED_TO;
import static org.metamart.schema.type.Relationship.CREATED;
import static org.metamart.schema.type.Relationship.IS_ABOUT;
import static org.metamart.schema.type.Relationship.MENTIONED_IN;
import static org.metamart.schema.type.Relationship.REPLIED_TO;
import static org.metamart.schema.type.TaskStatus.Open;
...
import static org.metamart.service.jdbi3.UserRepository.TEAMS_FIELD;
import static org.metamart.service.util.EntityUtil.compareEntityReference;
...
import org.metamart.service.resources.feeds.FeedUtil;
import org.metamart.service.resources.feeds.MessageParser;
import org.metamart.service.resources.feeds.MessageParser.EntityLink;
import org.metamart.service.security.AuthorizationException;
import org.metamart.service.security.Authorizer;
import org.metamart.service.security.policyevaluator.OperationContext;
import org.metamart.service.security.policyevaluator.ResourceContext;
