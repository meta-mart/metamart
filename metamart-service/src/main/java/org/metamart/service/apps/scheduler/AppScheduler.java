...
import static org.metamart.service.apps.AbstractNativeApplication.getAppRuntime;
...
import org.metamart.service.apps.NativeApplication;
...
public class AppScheduler {
  ...
  private AppScheduler(
      MetaMartApplicationConfig config, CollectionDAO dao, SearchRepository searchClient)
  ...
  private void overrideDefaultConfig(MetaMartApplicationConfig config) {
    defaultAppScheduleConfig.put(
