 ...
 */
package org.metamart.service.pipelineService.airflow;

import static org.junit.jupiter.api.Assertions.assertEquals;

import java.security.KeyStoreException;
import org.junit.jupiter.api.Test;
import org.metamart.schema.api.configuration.pipelineServiceClient.Parameters;
import org.metamart.schema.api.configuration.pipelineServiceClient.PipelineServiceClientConfiguration;
import org.metamart.service.clients.pipeline.airflow.AirflowRESTClient;
...
class AirflowRESTClientTest {
  ...
  void test_buildUri() throws KeyStoreException {
    ...
    assertEquals(
        "http://localhost:8080/api/v1/metamart/last_dag_logs",
    ...
    assertEquals(
        "http://localhost:8080/airflow/api/v1/metamart/last_dag_logs",
        restClient.buildURI("last_dag_logs").toString());
    ...
    restClient = new AirflowRESTClient(config);
    assertEquals(
        "http://localhost:8080/airflow/foo/api/v1/metamart/health",
