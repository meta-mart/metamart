...
public class SecretsManagerLifecycleTest {
    ...
    secretsManager =
        InMemorySecretsManager.getInstance(
            new SecretsManager.SecretsConfig(
                "metamart", "prefix", List.of("key1:value1", "key2:value2"), null));
  ...
  void testDatabaseServiceConnectionConfigLifecycle() {
    ...
    String secretName = "/prefix/metamart/database/test/authtype/password";
  ...
  void testWorkflowLifecycle() {
    String password = "metamart_password";
    String secretName =
        "/prefix/metamart/workflow/test-connection/request/connection/config/authtype/password";
  ...
  void test_buildSecretId() {
    ...
    assertEquals(
        "/prefix/metamart/database/test_name",
