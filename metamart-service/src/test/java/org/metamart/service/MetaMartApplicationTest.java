...
import org.metamart.schema.type.IndexMappingLanguage;
...
import org.metamart.service.resources.events.MSTeamsCallbackResource;
import org.metamart.service.resources.events.SlackCallbackResource;
import org.metamart.service.resources.events.WebhookCallbackResource;
...
public abstract class MetaMartApplicationTest {
  protected static final String CONFIG_PATH =
      ResourceHelpers.resourceFilePath("metamart-secure-test.yaml");
  ...
  public static final String ELASTIC_SEARCH_CLUSTER_ALIAS = "metamart";
  ...
  public static DropwizardAppExtension<MetaMartApplicationConfig> APP;
  ...
  public void createApplication() throws Exception {
    ...
    MetaMartApplicationConfig config = new MetaMartApplicationConfig();
  ...
  @NotNull
  protected DropwizardAppExtension<MetaMartApplicationConfig> getApp(
      ConfigOverride[] configOverridesArray) {
    return new DropwizardAppExtension<>(
        MetaMartApplication.class, CONFIG_PATH, configOverridesArray);
  }
