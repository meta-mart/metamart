...
import static org.metamart.service.resources.topics.TopicResourceTest.getField;
...
import static org.metamart.service.util.TestUtils.validateEntityReference;
...
import org.metamart.schema.api.data.CreateAPIEndpoint;
import org.metamart.schema.entity.data.APIEndpoint;
import org.metamart.schema.type.APIRequestMethod;
import org.metamart.schema.type.APISchema;
...
import org.metamart.schema.type.FieldDataType;
...
public class APIEndpointResourceTest extends EntityResourceTest<APIEndpoint, CreateAPIEndpoint> {
  ...
  void post_apiEndpointWithDifferentService_200_ok(TestInfo test) throws IOException {
      ...
      omAPIEndpoints.add(
          createAndCheckEntity(
              createRequest(String.format("%s%d", test.getDisplayName(), i))
                  .withApiCollection(METAMART_API_COLLECTION_REFERENCE.getFullyQualifiedName()),
              ADMIN_AUTH_HEADERS));
    }
    ...
    queryParams.put("apiCollection", METAMART_API_COLLECTION_REFERENCE.getFullyQualifiedName());
  ...
  public EntityReference getContainer() {
    return METAMART_API_COLLECTION_REFERENCE;
  }
