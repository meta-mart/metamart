...
import org.metamart.schema.entity.app.AppConfiguration;
...
import org.metamart.schema.entity.app.NativeAppPermission;
  ...
  public CreateAppMarketPlaceDefinitionReq createRequest(String name) {
    try {
      return new CreateAppMarketPlaceDefinitionReq()
          ...
          .withSupportEmail("test@metamart.org")
          .withPrivacyPolicyUrl("https://privacy@metamart.org")
          .withClassName("org.metamart.service.apps.bundles.test.NoOpTestApplication")
