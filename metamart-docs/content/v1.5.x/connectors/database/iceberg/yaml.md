...
- [Enable Security](#securing-rest-catalog-connection-with-ssl-in-metamart)
...
```bash
pip3 install "metamart-ingestion[iceberg]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/icebergConnection.json)
