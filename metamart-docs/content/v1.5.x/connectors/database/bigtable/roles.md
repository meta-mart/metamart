...
This documentation will guide you on how to create a custom role in GCP with the necessary permissions to ingest BigTable in MetaMart.
...
{% image
src="/images/v1.5/connectors/bigtable/create-role-1.png"
...
{% image
src="/images/v1.5/connectors/bigtable/create-role-2.png"
...
{% image
src="/images/v1.5/connectors/bigtable/create-role-3.png"
alt="Create Role"
caption="Create Role" /%}
...
{% image
src="/images/v1.5/connectors/bigtable/create-role-4.png"
alt="Add Permissions"
...
{% image
src="/images/v1.5/connectors/bigtable/create-role-5.png"
alt="Add Permissions"
caption="Add Permissions" /%}
