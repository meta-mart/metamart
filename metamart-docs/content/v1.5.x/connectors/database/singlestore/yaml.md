...
Configure and schedule Singlestore metadata and profiler workflows from the MetaMart UI:
...
```bash
pip3 install "metamart-ingestion[singlestore]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/singleStoreConnection.json)
