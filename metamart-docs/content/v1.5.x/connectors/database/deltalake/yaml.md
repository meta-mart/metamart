...
Configure and schedule Deltalake metadata and profiler workflows from the MetaMart UI:
...
```bash
pip3 install "metamart-ingestion[deltalake-spark]"
```

- If extracting directly from the storage

```bash
pip3 install "metamart-ingestion[deltalake-storage]"
```
...
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/deltaLakeConnection.json)
