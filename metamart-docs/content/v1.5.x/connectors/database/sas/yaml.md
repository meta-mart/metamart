...
Configure and schedule SAS metadata workflows from the MetaMart UI:
...
{%inlineCallout icon="description" bold="MetaMart 1.3.0 or later" href="/deployment"%}
...
```bash
pip3 install "metamart-ingestion[sas]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/sasConnection.json)
