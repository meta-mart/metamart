...
The current approach for authentication is based on `app registration`, reach out to us on [slack](https://slack.meta-mart.org/) if you find the need for another auth system
