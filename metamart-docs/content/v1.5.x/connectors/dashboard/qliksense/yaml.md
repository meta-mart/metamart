...
Configure and schedule PowerBI metadata and profiler workflows from the MetaMart UI:

- [Requirements](#requirements)
- [Metadata Ingestion](#metadata-ingestion)
- [Enable Security](#securing-qlik-sense-connection-with-ssl-in-metamart)
...
```bash
pip3 install "metamart-ingestion[qliksense]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/dashboard/qlikSenseConnection.json)
...
## Securing Qlik Sense Connection with SSL in MetaMart

To establish secure connections between MetaMart and Qlik Sense, there are two ways to communicate: defining the certificate file path or using the certificates value. 
...
Refer to the guide on how to generate authentication certificates so that MetaMart can communicate with Qlik Sense [here](/connectors/dashboard/qliksense/certificates).
