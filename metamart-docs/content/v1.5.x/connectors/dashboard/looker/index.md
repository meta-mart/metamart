...
- **Repository Owner**: The owner (user or organization) of a GitHub repository. For example, in https://github.com/meta-mart/MetaMart, the owner is `meta-mart`.
- **Repository Name**: The name of a GitHub repository. For example, in https://github.com/meta-mart/MetaMart, the name is `MetaMart`.
