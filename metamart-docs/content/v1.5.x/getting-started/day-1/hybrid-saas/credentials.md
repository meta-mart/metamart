...
The AWS Credentials are based on the following [JSON Schema](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/security/credentials/awsCredentials.json).
...
The GCP Credentials are based on the following [JSON Schema](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/security/credentials/gcpCredentials.json).
...
You can see a full demo setup [here](https://github.com/meta-mart/metamart-demo/tree/main/ingestion-github-actions).
...
From our Airflow host, (e.g., `docker exec -it metamart_ingestion bash` if testing in Docker), you can run:

```bash
airflow connections add 'my_mysql_db' \
    --conn-uri 'mysql+pymysql://metamart_user:metamart_password@mysql:3306/metamart_db'
```

You will see an output like

```
Successfully added `conn_id`=my_mysql_db : mysql+pymysql://metamart_user:metamart_password@mysql:3306/metamart_db
```
...
connection.login  # 'metamart_user'
connection.password  # 'metamart_password'
```
