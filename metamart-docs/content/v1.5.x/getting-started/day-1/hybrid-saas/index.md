...
2. **Run the connector in your infrastructure or laptop**: In this case, Digitrans won't be accessing the data, but rather
   you'd control where and how the process is executed and Digitrans will only receive the output of the metadata extraction.
...
Here you will define information such as where are you hosting the MetaMart server, and the JWT token to authenticate.
...
workflowConfig:
  ...
  metaMartServerConfig:
    hostPort: "https://customer.trydigitrans.io/api"
    authProvider: metamart
    securityConfig:
