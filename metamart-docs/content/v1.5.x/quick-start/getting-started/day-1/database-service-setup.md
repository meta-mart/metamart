...
You can quickly set up a database service for metadata extraction in MetaMart SaaS. Below is an example of how to configure a connection using the `Snowflake` Connector:

1. ### Log in to MetaMart SaaS 
...
Click Test Connection to verify the setup. This will check if MetaMart can reach the Snowflake service.
