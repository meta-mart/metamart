...
Tiering is an important concept of data classification in MetaMart. Data Producers and Consumers can set business importance of data by setting Tiers. `Tier 1` is the most important data of an organization.
