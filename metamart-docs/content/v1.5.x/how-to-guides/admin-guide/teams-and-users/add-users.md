...
If the user does not already exist in MetaMart, then [invite the user](/how-to-guides/admin-guide/teams-and-users/invite-users) to MetaMart. While creating the **new user**, you can add them to the relevant **Team** as well as assign them the relevant **Roles**.
...
If the user, already exists in MetaMart, then
