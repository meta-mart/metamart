...
{% image
src="/images/v1.5/how-to-guides/governance/glossary7.png"
...
When glossary terms have typos, users tend to delete the term. All the effort spent  in tagging the data assets is lost when terms are deleted. MetaMart supports renaming Glossary terms. Simply rename the terms.
