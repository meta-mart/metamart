...
The **Source** is the connector to external systems and outputs a record for downstream to process and push to MetaMart.
...
**test_connection** is used (by MetaMart supported connectors ONLY) to validate permissions and connectivity before moving forward with the ingestion.


## Example

A simple example of this implementation can be found in our demo Custom Connector [here](https://github.com/meta-mart/metamart-demo/blob/main/custom-connector/connector/my_csv_connector.py)

## For Consumers of Metamart-ingestion to define custom connectors in their own package with same namespace

As a consumer of Metamart-ingestion package, You can to add your custom connectors within the same namespace but in a different package repository.
...
If you want my_awesome_connector.py to build as a source and run as a part of workflows defined in metamart_ingestion below are the steps.
