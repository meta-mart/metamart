...
1. EntityId/Authority -> Same as IDP Metamart has an Entity Id
...
- Metamart is the service provider, we just update the `localhost` to the hosted URI.
...
To add a private key, you need to include it in the keystore and update the configuration details accordingly [here](https://github.com/meta-mart/MetaMart/blob/main/conf/metamart.yaml#L219).
