...
It also requires the ingestion package to be at least `metamart-ingestion==1.3.1.0`.
...
- `metamart-ingestion[<plugins>]==x.y.z`.
...
**Note:** This approach only has the `metamart/ingestion-base` ready from version 0.12.1 or higher!
