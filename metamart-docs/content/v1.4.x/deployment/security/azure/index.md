...
{% image src="/images/v1.4/deployment/security/azure/create-app-1.png" alt="create-app" /%} 

- Click on `New Registration`. This step is for registering the MetaMart UI.

{% image src="/images/v1.4/deployment/security/azure/create-app-2.png" alt="create-app" /%}
...
{% image src="/images/v1.4/deployment/security/azure/where-to-find-credentials.png" alt="create-app" /%}
