...
# Prerequisites
This guide will help you set up all prerequisites to develop on MetaMart.

MetaMart being a full stack project, we use the following for development:
...
```shell
git clone https://github.com/meta-mart/MetaMart
cd metamart
python3 -m venv env
...
### MetaMart API Backend

We use Java for developing MetaMart backend server. Following are the key technologies that we use for the backend:
