...
You can find the Lineage Entity defined [here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/type/entityLineage.json),
as well as the Entity defining the payload to add a new lineage: [AddLineage](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/api/lineage/addLineage.json).

{% note %}

Note that in MetaMart, the Lineage information is just a possible relationship between Entities. Other types
...
The point being, any Entity existent in MetaMart can be related to any other via Lineage.
...
All functions that we are going to use related to Lineage can be found in [here](https://github.com/meta-mart/MetaMart/blob/main/ingestion/src/metadata/ingestion/ometa/mixins/lineage_mixin.py)
...
Note how when adding lineage information we give to the API an [AddLineage](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/api/lineage/addLineage.json)
Request. This is composed of an Entity Edge, whose definition you can find [here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/type/entityLineage.json#L75).
...
In case you want MetaMart to identify the lineage based on the sql query, then you can make use of the method `add_lineage_by_query` of the python SDK to parser the sql and generate the lineage in MetaMart.
...
To create the automated sql lineage via CLI, you need to make sure that you have installed the metamart-ingestion package in your local environment using command `pip install metamart-ingestion`.
...
- **workflowConfig**: The main property here is the metaMartServerConfig, where you can define the host and security provider of your MetaMart installation.
