...
MetaMart tracks data lineage, showing how data moves through the organization's systems. Users can visualize how data is transformed and where it is used, helping with data traceability and impact analysis. MetaMart supports lineage for Database, Dashboard, and Pipelines.

{% image
src="/images/v1.4/how-to-guides/lineage/lineage1.png"
alt="Data Lineage in MetaMart"
caption="Data Lineage in MetaMart"
/%}
