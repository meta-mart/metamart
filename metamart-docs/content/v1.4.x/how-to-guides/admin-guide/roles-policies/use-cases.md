---
title: Use Cases - Creating Roles & Policies in MetaMart
slug: /how-to-guides/admin-guide/roles-policies/use-cases
---

# Use Cases: Creating Roles & Policies in MetaMart

MetaMart comes with default configurations such as the Organization Policy and Data Consumer Roles. These roles are setup to foster data collaboration.
...
alt="Creating Roles & Policies in MetaMart"
...
A data steward in MetaMart should be able to create Glossaries and Glossary Terms and be able to view all data and manage it for governance purposes.
