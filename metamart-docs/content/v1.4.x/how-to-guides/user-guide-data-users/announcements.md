...
- **Scheduled Date:** A date range can be added during which the announcement will be displayed in MetaMart. This consists of a start and end date.
...
{% note %}
**Advanced Tip:** Users can set up Alerts to be sent from MetaMart via Email,  Chat, Slack, MS Teams, and Webhooks. If alerts have been set up for Activity Feeds, then the concerned data owners and followers will be notified via email, Slack, etc.
{% /note %}
