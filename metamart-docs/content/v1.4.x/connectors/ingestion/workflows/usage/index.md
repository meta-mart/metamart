...
We can create a workflow that will obtain the query log and table creation information from the underlying database and feed it to MetaMart. The Usage Ingestion will be in charge of obtaining this data.
