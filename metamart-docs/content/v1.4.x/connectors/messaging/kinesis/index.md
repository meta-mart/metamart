...
Configure and schedule Kinesis metadata workflows from the MetaMart UI:

- [Requirements](#requirements)
- [Metadata Ingestion](#metadata-ingestion)

{% partial file="/v1.4/connectors/ingestion-modes-tiles.md" variables={yamlPath: "/connectors/messaging/kinesis/yaml"} /%}

## Requirements

The Kinesis connector ingests metadata using the Kinesis boto3 client.

MetaMart retrieves information about streams and sample data from the streams in the AWS account.
...
{% partial 
  ...
  variables={
    connector: "Kinesis", 
    selectServicePath: "/images/v1.4/connectors/kinesis/select-service.png",
    addNewServicePath: "/images/v1.4/connectors//add-new-service.png",
    serviceConnectionPath: "/images/v1.4/connectors/kinesis/service-connection.png",
} 
/%}
