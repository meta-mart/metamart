...
Configure and schedule SQLite metadata and profiler workflows from the MetaMart UI:
...
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/sqliteConnection.json)
