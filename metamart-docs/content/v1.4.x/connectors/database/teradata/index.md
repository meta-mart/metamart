...
Configure and schedule Teradata metadata and profiler workflows from the MetaMart UI:
...
## Requirements
{%inlineCallout icon="description" bold="MetaMart 1.4 or later" href="/deployment"%}
