...
Configure and schedule Redshift metadata and profiler workflows from the MetaMart UI:
...
- [Enable Security](#securing-redshift-connection-with-ssl-in-metamart)
...
```bash
pip3 install "metamart-ingestion[redshift]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/redshiftConnection.json)
...
## Securing Redshift Connection with SSL in MetaMart
