...
Configure and schedule PostgreSQL metadata and profiler workflows from the MetaMart UI:
...
To establish secure connections between MetaMart and a PostgreSQL database, you can configure SSL using different SSL modes provided by PostgreSQL, each offering varying levels of security.
