...
Configure and schedule Postgres metadata and profiler workflows from the MetaMart UI:
...
- [Enable Security](#securing-postgres-connection-with-ssl-in-metamart)
...
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/postgresConnection.json)
...
## Securing Postgres Connection with SSL in MetaMart

To configure SSL for secure connections between MetaMart and a PostgreSQL database, PostgreSQL offers various SSL modes, each providing different levels of connection security.
