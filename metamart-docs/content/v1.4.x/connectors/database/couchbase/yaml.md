...
Configure and schedule Couchbase metadata workflows from the MetaMart UI:
...
```bash
pip3 install "metamart-ingestion[couchbase]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/couchbaseConnection.json)
...
**bucketName**: Optional name to give to the bucket name in MetaMart. If left blank, we will ingest all the bucket names.
