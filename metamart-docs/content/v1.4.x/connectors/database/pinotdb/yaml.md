...
Configure and schedule PinotDB metadata and profiler workflows from the MetaMart UI:
...
```bash
pip3 install "metamart-ingestion[pinotdb]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/pinotDBConnection.json)
