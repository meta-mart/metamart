...
```bash
pip3 install "metamart-ingestion[airflow]"
```
...
Instead, just run `pip3 install "metamart-ingestion"`.
...
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/pipeline/airbyteConnection.json)
