...
Configure and schedule Looker metadata and profiler workflows from the MetaMart UI:
...
```bash
pip3 install "metamart-ingestion[looker]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas. 
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/dashboard/lookerConnection.json)
...
- **repositoryOwner**: The owner (user or organization) of a GitHub repository. For example, in https://github.com/meta-mart/MetaMart, the owner is `meta-mart`.
- **repositoryName**: The name of a GitHub repository. For example, in https://github.com/meta-mart/MetaMart, the name is `MetaMart`.
...
```yaml {% srNumber=4 %}
      gitCredentials:
        ...
        repositoryOwner: meta-mart
        repositoryName: MetaMart
        token: XYZ
```
