...
Note that this document is just to give transparency and clarity to anyone who is interested in understanding the backend database of MetaMart.
...
Any operations on the platform should be done through the MetaMart API.
...
The `relation` types are defined - as everything else - as a [JSON Schema](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/type/entityRelationship.json#L15).
...
3. `labelType`: Internally use to flag the origin of a tag ([source](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/type/tagLabel.json#L44))
