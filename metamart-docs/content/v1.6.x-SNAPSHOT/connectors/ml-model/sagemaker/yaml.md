...
Configure and schedule Sagemaker metadata and profiler workflows from the MetaMart UI:
...
MetaMart retrieves information about models and tags associated with the models in the AWS account.
...
```bash
pip3 install "metamart-ingestion[sagemaker]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/mlmodel/sageMakerConnection.json )
...
[JSON Schema](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/metadataIngestion/mlmodelServiceMetadataPipeline.json)
