...
Configure and schedule S3 Datalake metadata and profiler workflows from the MetaMart UI:
...
If running MetaMart version greater than 0.13, you will need to install the Datalake ingestion for S3:
