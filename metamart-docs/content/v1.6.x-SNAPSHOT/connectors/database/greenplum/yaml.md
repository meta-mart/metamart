...
Configure and schedule Greenplum metadata and profiler workflows from the MetaMart UI:
...
- [Lineage](#lineage)
- [Enable Security](#securing-greenplum-connection-with-ssl-in-metamart)
...
```bash
pip3 install "metamart-ingestion[postgres]"
```

## Metadata Ingestion

All connectors are defined as JSON Schemas.
[Here](https://github.com/meta-mart/MetaMart/blob/main/metamart-spec/src/main/resources/json/schema/entity/services/connections/database/greenplumConnection.json)
...
## Securing Greenplum Connection with SSL in MetaMart

To configure SSL for secure connections between MetaMart and a Greenplum database, Greenplum offers various SSL modes, each providing different levels of connection security.
