...
Configure and schedule Flink metadata and profiler workflows from the MetaMart UI:
...
```bash
pip3 install "metamart-ingestion[flink]"
```
...
**Flink Connect Config**: MetaMart supports SSL config or no Authentication.
