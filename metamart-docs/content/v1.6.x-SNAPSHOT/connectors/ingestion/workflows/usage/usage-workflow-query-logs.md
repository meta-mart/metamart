...
In order to extract usage information, MetaMart parses the queries that have run against the database. This query
...
Create a new file called `query_log_usage.yaml` in the current directory. Note that the current directory should be the metamart directory.
