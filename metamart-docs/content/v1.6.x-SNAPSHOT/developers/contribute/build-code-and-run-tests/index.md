...
In this page we go through how to build MetaMart code and get a developer environment up and running.

- [Install prerequisites](/developers/contribute/build-code-and-run-tests/prerequisites)
- [Setup MetaMart Server code in IntelliJ](/developers/contribute/build-code-and-run-tests/metamart-server)
...
- [Build MetaMart UI](/developers/contribute/build-code-and-run-tests/metamart-ui)
