...
After the applying these steps, the users in your realm are able to login in the metamart, as a suggestion create a user called "admin-user". Now you can update the configuration of your deployment:
...
{% note %}
A dockerized demo for showing how this SSO works with MetaMart can be found [here](https://github.com/meta-mart/metamart-demo/tree/main/keycloak-sso).
{% /note %}
