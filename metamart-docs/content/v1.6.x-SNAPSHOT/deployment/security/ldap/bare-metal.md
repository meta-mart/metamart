...
MetaMart Specific Configuration :
...
- `adminPrincipals`: This is the list of admin Principal for the MetaMart , if mail in ldap is example@meta-mart.org, then if we want this user to be admin in the OM, we should add 'example', in this list.
