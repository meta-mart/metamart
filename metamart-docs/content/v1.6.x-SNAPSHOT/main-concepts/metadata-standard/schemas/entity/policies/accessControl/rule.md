...
*Describes an Access Control Rule for MetaMart Metadata Operations. All non-null user (subject) and entity (object) attributes are evaluated with logical AND.*
