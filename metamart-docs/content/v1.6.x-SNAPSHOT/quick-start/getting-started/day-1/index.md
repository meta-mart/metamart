...
Get started with your MetaMart service in a few simple steps:
...
4. Explore the Features: Dive into MetaMart's extensive feature set to unlock the full potential of your data.

**Ready to begin? Let's get started!**

## Requirements

You should receive your initial MetaMart credentials from MetaMart support, or from your existing MetaMart admin. For any questions, please reach us via [slack](https://slack.meta-mart.org/). The following steps will provide initial set up information, with links to more detailed documentation.

## Step 1: Set up a Data Connector

Once you have logged into your MetaMart instance, set up a data connector to start ingesting metadata. MetaMart provides [80+ turnkey connectors](/connectors) for a wide range of services, including:
...
1. **Run the connector in MetaMart**: In this scenario, an IP will be provided when you add the service. You must allow access to this IP in your data sources.
  
{% tilesContainer %}
{% tile
  title="Run the connector in MetaMart"
...
2. **Run the connector in your infrastructure or on a local machine:**: This hybrid model allows organizations to run metadata ingestion components within their own infrastructure. This ensures that MetaMart's managed service doesn't need direct access to the underlying data. Only metadata is collected locally and securely transmitted to the platform, maintaining data privacy and security.
...
to import metadata into MetaMart on a regular schedule.
...
To invite users you will need to ensure that you have an SMTP server available. With the information for your SMTP server you can configure MetaMart to send email alerts by updating the details from the UI.
...
After metadata has been ingested into MetaMart, you can [invite users](/how-to-guides/admin-guide/teams-and-users/invite-users) to collaborate on the data and assign different roles.
...
MetaMart offers a comprehensive platform for data teams to:
...
Explore these features and unlock the full potential of your data using MetaMart.
