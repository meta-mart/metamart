...
class PGSpiderLineageUnitTests(TestCase):
    ...
    def __init__(self, methodName) -> None:
        ...
        config = MetaMartWorkflowConfig.model_validate(mock_pgspider_config)
    ...
    def test_next_record_6(self, multi_tenant_tables):
        ...
        All multi tenant tables and child foreign tables have not been ingested into meta-mart.
        """
