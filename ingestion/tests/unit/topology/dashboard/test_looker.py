...
class LookerUnitTest(TestCase):
    ...
    def __init__(self, methodName, test_connection) -> None:
        ...
        self.config = MetaMartWorkflowConfig.model_validate(MOCK_LOOKER_CONFIG)
        ...
        self.looker: LookerSource = LookerSource.create(
            ...
            MetaMart(self.config.workflowConfig.metaMartServerConfig),
        )
    ...
    def test_create(self):
        ...
        not_looker_source = {
            ...
            "serviceConnection": {
                "config": {
                    ...
                    "authType": {"password": "metamart_password"},
        ...
        self.assertRaises(
            ...
            LookerSource.create,
            not_looker_source,
            self.config.workflowConfig.metaMartServerConfig,
        )
    ...
    def test_render_table_name(self):
        """
        Check that table is rendered correctly if "metamart" or default condition apply, or no templating is present
        """
    ...
    def test_build_lineage_request(self):
        ...
        with patch.object(fqn, "build", return_value=None), patch.object(
            MetaMart, "get_by_name", return_value=None
        ):
            self.assertIsNone(
        ...
        with patch.object(fqn, "build", return_value=None), patch.object(
            MetaMart, "get_by_name", return_value=table
        ):
            self.assertEqual(
    ...
    def test_yield_dashboard_usage(self):
        ...
        with patch.object(MetaMart, "get_by_name", return_value=return_value):
            self.assertEqual(
