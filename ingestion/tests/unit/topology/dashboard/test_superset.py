...
class SupersetUnitTest(TestCase):
    ...
    def __init__(self, methodName) -> None:
        ...
        self.config = MetaMartWorkflowConfig.model_validate(
            MOCK_SUPERSET_API_CONFIG
        )
    ...
    def test_db_get_database_name(self):
        ...
        sqa_str3 = "postgres://user:pass@localhost:8888/metamart_db"
        self.assertEqual(
            self.superset_db._get_database_name(  # pylint: disable=protected-access
        ...
        sqa_str4 = "postgres://user:pass@localhost:8888/metamart_db"
        self.assertEqual(
            self.superset_db._get_database_name(  # pylint: disable=protected-access
