...
class PostgresUnitTest(TestCase):
    ...
    def __init__(self, methodName, test_connection) -> None:
        ...
        self.config = MetaMartWorkflowConfig.model_validate(mock_postgres_config)
        ...
        self.usage_config = MetaMartWorkflowConfig.model_validate(
            mock_postgres_usage_config
        )
        self.postgres_usage_source = PostgresUsageSource.create(
            mock_postgres_usage_config["source"],
            self.usage_config.workflowConfig.metaMartServerConfig,
        )
