...
JDBC_PARSING_EXAMPLES = [
    ...
    (
        "jdbc:mysql://localhost:3306/metamart_db?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC",
        DEFAULT_DATABASE,
        "metamart_db",
        None,
    ),
    (
        "jdbc:mysql://localhost:3306/metamart_db?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC:filter",
        DEFAULT_DATABASE,
        "metamart_db",
        "filter",
    ),
...
class SplineUnitTest(TestCase):
    ...
    def __init__(self, methodName, test_connection) -> None:
        ...
        config = MetaMartWorkflowConfig.model_validate(mock_spline_config)
