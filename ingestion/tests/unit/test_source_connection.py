...
class SourceConnectionTest(TestCase):
    ...
    def test_mysql_url(self):
        ...
        expected_url = "mysql+pymysql://metamart_user:@localhost:3306"
    ...
    def test_postgres_url(self):
        # connection arguments with db
        expected_url = "postgresql+psycopg2://metamart_user:@localhost:5432/default"
    ...
    def test_singleStore_url(self):
        # connection arguments without db
        expected_url = "mysql+pymysql://metamart_user:@localhost:5432"
    ...
    def test_db2_url(self):
        # connection arguments with db
        expected_url = "db2+ibm_db://metamart_user:@localhost:50000/testdb"
