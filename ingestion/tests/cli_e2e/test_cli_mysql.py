...
class MysqlCliTest(CliCommonDB.TestSuite, SQACommonMethods):
    ...
    drop_table_query: str = """
        DROP TABLE IF EXISTS metamart_db.persons;
    """

    drop_view_query: str = """
        DROP VIEW  IF EXISTS metamart_db.view_persons;
    """
    ...
    def fqn_created_table() -> str:
        return "local_mysql.default.metamart_db.persons"
