...
def run_data_quality_workflow(
    ...
    test_suite_config = MetaMartWorkflowConfig(
        source=Source(
...
def test_all_definition_exists(metadata, run_data_quality_workflow, db_service):
    test_difinitions_glob = (
        ...
        + "/../../../.."
        + "/metamart-service/src/main/resources/json/data/tests/**.json"
    )
...
def test_data_quality(
    run_data_quality_workflow, metadata: MetaMart, test_case_name, expected_status
):
