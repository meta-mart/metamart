...
def create_data(mlflow_environment):
    ...
    csv_url = "https://raw.githubusercontent.com/meta-mart/metamart-demo/main/resources/winequality-red.csv"
...
def ingest_mlflow(metadata, service, create_data):
    workflow_config = MetaMartWorkflowConfig(
        ...
        workflowConfig=WorkflowConfig(metaMartServerConfig=metadata.config),
    )
