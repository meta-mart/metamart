...
"""
MetaMart high-level API Chart test
"""
...
class OMetaServiceTest(TestCase):
    ...
    admin_metadata = MetaMart(server_config)
    ...
    server_config.securityConfig = MetaMartJWTClientConfig(
    ...
    def test_create_db_service_without_connection(self):
        ...
        metadata_no_password = MetaMart(server_config)
