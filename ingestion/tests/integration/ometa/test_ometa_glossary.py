...
"""
MetaMart high-level API Glossary test
"""
import logging
import time
...
class OMetaGlossaryTest(TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.user_1 = cls.metadata.create_or_update(
            data=CreateUserRequest(
                ...
                email=Email(root="test.user.1@trydigitrans.io"),
            ),
        )
        ...
        cls.user_2 = cls.metadata.create_or_update(
            data=CreateUserRequest(
                ...
                email=Email(root="test.user.2@trydigitrans.io"),
            ),
        )
        ...
        cls.user_3 = cls.metadata.create_or_update(
            data=CreateUserRequest(
                ...
                email=Email(root="test.user.3@trydigitrans.io"),
            ),
        )
    ...
    def test_patch_glossary_term_references(self):
        ...
        dest_glossary_term_1.references.append(
            TermReference(name="GT1S1", endpoint="https://www.trydigitrans.io")
        )
        # Add reference
        res: GlossaryTerm = self.metadata.patch(
            entity=GlossaryTerm,
        ...
        dest_glossary_term_1.references.append(
            TermReference(name="GT1S2", endpoint="https://meta-mart.org/")
        )
        dest_glossary_term_1.references.append(
            TermReference(
                name="GT1S3", endpoint="https://github.com/meta-mart/MetaMart"
            )
        )
