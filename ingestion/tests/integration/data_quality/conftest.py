...
from _metamart_testutils.postgres.conftest import postgres_container, try_bind
...
def ingest_mysql_service(
    mysql_container: MySqlContainer, metadata: MetaMart, tmp_path_factory
):
    workflow_config = {
        "source": {
            "type": "mysql",
...
def ingest_postgres_metadata(
    postgres_service, metadata: MetaMart, sink_config, workflow_config, run_workflow
):
    workflow_config = {
        "source": {
