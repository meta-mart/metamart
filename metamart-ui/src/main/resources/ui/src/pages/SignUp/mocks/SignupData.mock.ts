...
export const mockCreateUser = {
  data: {
    ...
    href: 'http://sandbox-beta.meta-mart.org/api/v1/users/911d4be4-6ebf-48a0-9016-43a2cf716428',
    isAdmin: false,
    profile: {
      images: {
        image: '',
    ...
    teams: [
      {
        ...
        deleted: false,
        href: 'http://sandbox-beta.meta-mart.org/api/v1/teams/606c1d33-213b-4626-a619-0e4cef9f5069',
      },
    ],
    deleted: false,
    inheritedRoles: [
      {
        ...
        deleted: false,
        href: 'http://sandbox-beta.meta-mart.org/api/v1/roles/4509b668-2882-45c3-90e1-4551043f8cbd',
      },
    ],
  },
};
