...
import metaMartConnection from '../jsons/connectionSchemas/connections/metadata/metaMartConnection.json';
...
export const getMetadataConfig = (type: MetadataServiceType) => {
  ...
  switch (type) {
    ...
    case MetadataServiceType.MetaMart: {
      schema = metaMartConnection;
