...
export const ROUTES = {
  ...
  SETTINGS_EDIT_EMAIL_CONFIG: `/settings/MetaMart/email/edit-email-configuration`,
  STORE: '/store',
  FEEDS: '/feeds',
  DUMMY: '/dummy',
  ...
  SETTINGS_EDIT_CUSTOM_LOGIN_CONFIG: `/settings/MetaMart/loginConfiguration/edit-custom-login-configuration`,
