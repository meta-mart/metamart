    ...
    hits: [
      {
        ...
        _source: {
          ...
          updatedAt: 1682049945635,
          updatedBy: 'admin',
          href: 'http://metamart-server:8585/api/v1/tables/9d664bbd-8c9e-4068-9112-9ab0457d4c52',
          tableType: 'Regular',
          columns: [
            {
              name: 'address_id',
          ...
          databaseSchema: {
            ...
            description:
              'This **mock** database contains schema related to shopify sales and orders with related dimension tables.',
            deleted: false,
            href: 'http://metamart-server:8585/api/v1/databaseSchemas/be37a61e-fb10-4748-86ab-0714613a42ea',
          },
          database: {
            id: '0dac7caf-8419-4a0b-a96e-345730b2c0f5',
            type: 'database',
            ...
            description:
              'This **mock** database contains schemas related to shopify sales and orders with related dimension tables.',
            deleted: false,
            href: 'http://metamart-server:8585/api/v1/databases/0dac7caf-8419-4a0b-a96e-345730b2c0f5',
          },
          service: {
            id: 'f24cd129-f864-45d9-8cce-46a9aecd6846',
            type: 'databaseService',
            ...
            fullyQualifiedName: 'sample_data',
            deleted: false,
            href: 'http://metamart-server:8585/api/v1/services/databaseServices/f24cd129-f864-45d9-8cce-46a9aecd6846',
          },
          serviceType: 'BigQuery',
          tags: [],
          deleted: false,
      ...
      },
      {
        ...
        _source: {
          ...
          updatedBy: 'admin',
          href: 'http://metamart-server:8585/api/v1/tables/f1f03f22-24d6-4e88-a6bc-6aa0b03f0da0',
          tableType: 'Regular',
          columns: [
            {
              name: 'address_id',
      ...
      },
      {
        ...
        _source: {
          ...
          updatedBy: 'admin',
          href: 'http://metamart-server:8585/api/v1/tables/94edd207-9d60-40cc-aa73-615e8fe20e97',
          tableType: 'Regular',
          columns: [
            {
              name: 'line_item_id',
      ...
      },
      {
        ...
        _source: {
          ...
          updatedBy: 'admin',
          href: 'http://metamart-server:8585/api/v1/tables/4e3556eb-ac18-456e-b8ba-ea4a42dac422',
          tableType: 'Regular',
          columns: [
            {
