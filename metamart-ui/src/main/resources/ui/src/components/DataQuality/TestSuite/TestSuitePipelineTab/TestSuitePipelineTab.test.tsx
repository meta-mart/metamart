...
const mockTestSuite = {
  ...
  name: 'mySQL.metamart_db.metamart_db.web_analytic_event.testSuite',
  fullyQualifiedName:
    'mySQL.metamart_db.metamart_db.web_analytic_event.testSuite',
  tests: [],
  pipelines: [
    {
      ...
      fullyQualifiedName:
        'mySQL.metamart_db.metamart_db.web_analytic_event.testSuite.web_analytic_event_TestSuite',
      deleted: false,
    },
  ],
  ...
  executableEntityReference: {
    ...
    fullyQualifiedName:
      'mySQL.metamart_db.metamart_db.web_analytic_event',
  },
  summary: {
    success: 0,
    failed: 1,
