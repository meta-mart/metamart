...
export const mockTopicEntityDetails: Topic = {
  ...
  updatedBy: 'admin',
  href: 'http://metamart-server:8585/api/v1/topics/67e1dbbb-054c-4833-ba28-f95d71f0826f',
  deleted: false,
  service: {
    ...
    deleted: false,
    href: 'http://metamart-server:8585/api/v1/services/messagingServices/5d6f73f0-1811-49c8-8d1d-7a478ffd8177',
  },
  partitions: 0,
...
export const mockTopicByFqnResponse = {
  ...
  messageSchema: {
    schemaText:
      '{"namespace":"metamart.kafka","type":"record","name":"Product","fields":[{"name":"product_id","type":"int"}]}',
