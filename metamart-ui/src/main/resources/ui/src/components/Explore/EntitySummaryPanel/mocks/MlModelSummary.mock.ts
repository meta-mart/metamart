...
export const mockMlModelEntityDetails: Mlmodel = {
      ...
      featureSources: [
        {
          ...
          dataSource: {
            ...
            href: 'http://metamart-server:8585/api/v1/tables/148e01f8-817a-4094-aa39-970746e3427e',
          },
        },
      ],
    },
      ...
      featureSources: [
        {
          ...
          dataSource: {
            ...
            href: 'http://metamart-server:8585/api/v1/tables/e2e27b89-9eda-441f-afe4-3c9b780e9e15',
          },
        },
        {
          name: 'platform',
  ...
  tags: [],
  followers: [],
  href: 'http://metamart-server:8585/api/v1/mlmodels/e42a5d43-36fd-4636-ae89-5bcc6a61542e',
  deleted: false,
};
...
export const mockMlModelEntityDetails1: Mlmodel = {
  ...
  tags: [],
  followers: [],
  href: 'http://metamart-server:8585/api/v1/mlmodels/b849cc70-ceda-4f2a-8de2-022a5c7f78a6',
  deleted: false,
};
