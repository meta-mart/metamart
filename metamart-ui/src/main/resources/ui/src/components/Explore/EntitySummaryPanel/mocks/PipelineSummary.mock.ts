...
export const mockPipelineEntityDetails: Pipeline = {
  ...
  deleted: false,
  href: 'http://metamart-server:8585/api/v1/pipelines/b35f7a53-16a9-4ed1-9223-801c3d75674f',
  followers: [],
  tags: [],
  service: {
    ...
    deleted: false,
    href: 'http://metamart-server:8585/api/v1/services/pipelineServices/d1c5f7b4-dc61-4336-a4b1-a27e0b97d791',
  },
};
