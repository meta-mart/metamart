  ...
  charts: [
    {
      ...
      deleted: false,
      href: 'http://metamart-server:8585/api/v1/charts/eba9c260-4036-4c57-92fe-6c6e3d703bda',
    },
  ],
  href: 'http://metamart-server:8585/api/v1/dashboards/2edaff89-b1d4-47b6-a081-d72f08e1def9',
  followers: [],
  service: {
    ...
    deleted: false,
    href: 'http://metamart-server:8585/api/v1/services/dashboardServices/38ae6d66-7086-4e00-b2d6-cabd2b951993',
  },
