...
const mockEntityDetails: Container = {
  ...
  updatedBy: 'admin',
  href: 'http://metamart-server:8585/api/v1/containers/63be99e5-8ebf-44b6-8247-0f4faed00798',
  service: {
    ...
    deleted: false,
    href: 'http://metamart-server:8585/api/v1/services/storageServices/7ab99e67-b578-4361-bad2-9076a52b341d',
  },
  dataModel: {
    isPartitioned: true,
    columns: [
