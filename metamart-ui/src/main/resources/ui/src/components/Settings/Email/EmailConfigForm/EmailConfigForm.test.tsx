...
const emailConfigValues = {
  emailingEntity: 'MetaMart',
  supportUrl: 'https://slack.meta-mart.org',
  enableSmtpServer: false,
  metaMartUrl: 'http://localhost:3000/',
...
describe('Email Config Form Component', () => {
  ...
  it('should render email config form', async () => {
    ...
    expect(screen.getByText('label.meta-mart-url')).toBeInTheDocument();
    ...
    expect(screen.getByTestId('meta-mart-url-input')).toBeInTheDocument();
