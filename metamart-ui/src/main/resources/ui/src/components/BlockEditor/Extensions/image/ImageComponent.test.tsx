...
const mockNode = {
  attrs: {
    src: 'https://meta-mart.org/images/omd-logo.svg',
    alt: 'OMD Logo',
  },
...
describe('ImageComponent', () => {
  it('should render without crashing', async () => {
    ...
    expect(imageNode).toHaveAttribute(
      'src',
      'https://meta-mart.org/images/omd-logo.svg'
    );
  ...
  it('embed image link form should work as expected', async () => {
    ...
    await act(async () => {
      ...
      userEvent.type(embedInput, 'https://meta-mart.org/images/omd-logo');
    });
    ...
    expect(mockUpdateAttributes).toHaveBeenCalledWith({
      src: 'https://meta-mart.org/images/omd-logo.svgo',
    });
  });
