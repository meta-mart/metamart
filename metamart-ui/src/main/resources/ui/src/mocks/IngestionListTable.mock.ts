...
export const mockESIngestionData: IngestionPipeline = {
  ...
  service: {
    ...
    name: 'MetaMart',
    fullyQualifiedName: 'MetaMart',
    description: 'Service Used for creating MetaMart Ingestion Pipelines.',
    displayName: 'MetaMart Service',
    deleted: false,
    href: 'http://sandbox-beta.meta-mart.org/api/v1/services/databaseServices/d520c9bb-a517-4f1e-8962-d8518de71279',
  },
  pipelineStatuses: {
  ...
  deployed: true,
  enabled: false,
  href: 'http://sandbox-beta.meta-mart.org/api/v1/services/ingestionPipelines/5ff66f1c-9809-4333-836e-ba4dadda11f2',
  version: 0.5,
...
export const mockPipelineActionsProps: PipelineActionsProps = {
  ...
  ingestionPipelinePermissions: {
    MetaMart_elasticSearchReIndex: ENTITY_PERMISSIONS,
  },
