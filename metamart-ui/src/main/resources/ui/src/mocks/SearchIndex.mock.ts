...
export const MOCK_SEARCH_INDEX: SearchIndex = {
  ...
  service: {
    ...
    deleted: false,
    href: 'http://sandbox-beta.meta-mart.org/api/v1/services/storageServices/43bcffa8-89e7-45f5-9518-9247c56a1de7',
  },
  ...
  href: 'http://sandbox-beta.meta-mart.org/api/v1/searchIndexes/5cb19694-636d-4c8f-93cf-ed6f6a135da7',
  changeDescription: {
    fieldsAdded: [],
    fieldsUpdated: [],
    fieldsDeleted: [],
  ...
  domain: {
    ...
    href: 'http://sandbox-beta.meta-mart.org/api/v1/domains/52fc9c67-78b7-42bf-8147-69278853c230',
  },
  dataProducts: [],
  votes: {
    upVotes: 0,
