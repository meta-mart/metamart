  ...
  connection: {
    config: {
      ...
      awsConfig: {
        ...
        assumeRoleSessionName: 'MetaMartSession',
      },
      supportsMetadataExtraction: true,
    },
  },
  ...
  owners: [
    {
      ...
      deleted: false,
      href: 'http://sandbox-beta.meta-mart.org/api/v1/users/7a12b462-36c7-488a-b4c2-9756918704cb',
    },
  ],
  href: 'http://sandbox-beta.meta-mart.org/api/v1/services/databaseServices/9b09f404-7713-4f04-b7db-95111bac0c59',
  changeDescription: {
    fieldsAdded: [],
    fieldsUpdated: [
      {
...
export const MOCK_ATHENA_SERVICE = {
  ...
  type: 'object',
  javaType:
    'org.metamart.schema.services.connections.database.AthenaConnection',
  definitions: {
    athenaType: {
  ...
  properties: {
    ...
    awsConfig: {
      ...
      type: 'object',
      javaType: 'org.metamart.schema.security.credentials.AWSCredentials',
      properties: {
        awsAccessKeyId: {
    ...
    databaseName: {
      title: 'Database Name',
      description:
        'Optional name to give to the database in MetaMart. If left blank, we will use default as the database name.',
      type: 'string',
    },
    connectionOptions: {
      title: 'Connection Options',
      javaType:
        'org.metamart.schema.services.connections.database.ConnectionOptions',
      description:
    ...
    connectionArguments: {
      ...
      javaType:
        'org.metamart.schema.services.connections.database.ConnectionArguments',
      description:
    ...
    supportsQueryComment: {
      ...
      description:
        'For Database Services using SQLAlchemy, True to enable running a comment for all queries run from MetaMart.',
      type: 'boolean',
      default: true,
    },
    ...
    sampleDataStorageConfig: {
      ...
      type: 'object',
      javaType:
        'org.metamart.schema.services.connections.database.SampleDataStorageConfig',
      properties: {
        config: {
          oneOf: [
            {
                  ...
                  oneOf: [
                    {
                      ...
                      type: 'object',
                      javaType:
                        'org.metamart.schema.security.credentials.AWSCredentials',
                      properties: {
                        awsAccessKeyId: {
                          title: 'AWS Access Key ID',
                          description: 'AWS Access key ID.',
...
export const AIR_BYTE_CONNECTION = {
  ...
  type: 'object',
  javaType:
    'org.metamart.schema.services.connections.pipeline.AirbyteConnection',
  definitions: {
    AirbyteType: {
      description: 'Service type.',
      type: 'string',
...
export const ATLAS_CONNECTION = {
  ...
  type: 'object',
  javaType:
    'org.metamart.schema.services.connections.metadata.AtlasConnection',
  definitions: {
    atlasType: {
      description: 'Service type.',
      type: 'string',
