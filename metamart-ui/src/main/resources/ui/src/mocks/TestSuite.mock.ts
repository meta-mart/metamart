...
export const MOCK_TABLE_ROW_INSERTED_COUNT_TO_BE_BETWEEN = {
  ...
  updatedBy: 'admin',
  href: 'http://sandbox-beta.meta-mart.org/api/v1/dataQuality/testDefinitions/756c7770-0af3-49a9-9905-75a2886e5eec',
  deleted: false,
};
...
export const MOCK_TABLE_COLUMN_NAME_TO_EXIST = {
  ...
  updatedBy: 'admin',
  href: 'http://sandbox-beta.meta-mart.org/api/v1/dataQuality/testDefinitions/6d4e4673-fd7f-4b37-811e-7645c3c17e93',
  deleted: false,
};
