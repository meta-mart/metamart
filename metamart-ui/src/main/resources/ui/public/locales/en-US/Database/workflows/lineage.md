...
Note that in order to find the lineage information, you will first need to have the tables in MetaMart by running the Metadata Workflow. We use the table names identified in the queries to match the information present in MetaMart.
