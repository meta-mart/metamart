...
**Include**: Explicitly include Dashboards by adding a list of regular expressions to the `Include` field. MetaMart will include all Dashboards with names matching one or more of the supplied regular expressions. All other Dashboards will be excluded.
...
**Exclude**: Explicitly exclude Dashboards by adding a list of regular expressions to the `Exclude` field. MetaMart will exclude all Dashboards with names matching one or more of the supplied regular expressions. All other Dashboards will be included.
...
**Include**: Explicitly include Charts by adding a list of regular expressions to the `Include` field. MetaMart will include all Charts with names matching one or more of the supplied regular expressions. All other Charts will be excluded.
...
**Exclude**: Explicitly exclude Charts by adding a list of regular expressions to the `Exclude` field. MetaMart will exclude all Charts with names matching one or more of the supplied regular expressions. All other Charts will be included.
...
**Include**: Explicitly include Data Models by adding a list of regular expressions to the `Include` field. MetaMart will include all Data Models with names matching one or more of the supplied regular expressions. All other Data Models will be excluded.
...
**Exclude**: Explicitly exclude Data Models by adding a list of regular expressions to the `Exclude` field. MetaMart will exclude all Data Models with names matching one or more of the supplied regular expressions. All other Data Models will be included.
...
Optional configuration to soft delete `dashboards` in MetaMart if the source `dashboards` are deleted. After deleting, all the associated entities like lineage, etc., with that `dashboard` will be deleted.
$$
