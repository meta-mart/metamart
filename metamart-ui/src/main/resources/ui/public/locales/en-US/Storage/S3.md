...
By default, the S3 connector will ingest only top-level containers (Buckets). If you want to extract any information from within and their data models, you can follow the [docs](https://docs.meta-mart.org/connectors/storage).
...
You can find further information on the Kafka connector in the [docs](https://docs.meta-mart.org/connectors/storage/s3).
