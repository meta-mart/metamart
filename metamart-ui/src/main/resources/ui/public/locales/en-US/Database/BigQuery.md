...
You can visit [this](https://docs.meta-mart.org/connectors/database/bigquery/roles) documentation on how you can create a custom role in GCP and assign the above permissions to the role & service account!

You can find further information on the BigQuery connector in the [docs](https://docs.meta-mart.org/connectors/database/bigquery).
...
If you have attached policy tags to the columns of table available in BigQuery, then MetaMart will fetch those tags and attach it to the respective columns.
