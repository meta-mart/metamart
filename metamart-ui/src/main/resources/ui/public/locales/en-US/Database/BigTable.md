...
You can visit [this](https://docs.meta-mart.org/connectors/database/bigtable/roles) documentation on how you can create a custom role in GCP and assign the above permissions to the role & service account!

You can find further information on the BigTable connector in the [docs](https://docs.meta-mart.org/connectors/database/bigtable).
