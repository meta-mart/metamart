...
MetaMart retrieves information about streams and sample data from the streams in the AWS account. The user must have the following policy set to access the metadata from Kinesis.
...
You can find further information on the Kinesis connector in the [docs](https://docs.meta-mart.org/connectors/messaging/kinesis).
